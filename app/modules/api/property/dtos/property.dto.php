...
class PropertyDTO extends DTO {
	...
	public static function validate(string $name, string $CEP, string $neighborhood, string $adress_number, string $complement, string $city, string $UF, string $description, int $client_id) {
